...
var Toolbar = ({ onSave }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "sticky left-0 top-0 z-[200] flex w-full items-center justify-center gap-1 bg-white px-[1rem] py-[0.5rem] shadow", children: [
...
var SeatPicker = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `relative h-full w-full bg-gray-200 ${className}`, children: [
    !readOnly && (renderToolbar ? renderToolbar({ onSave: onSave || (() => {
    }) }) : /* @__PURE__ */ jsx(toolbar_default, { onSave: onSave || (() => {
    }) })),
    /* @__PURE__ */ jsxs("div", { className: "flex h-full w-full justify-between", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
